...
## []()Remote SDK Configuration[#](#remote-sdk-configuration "Direct link to heading")
...
### []()Track once on initialize[#](#track-once-on-initialize "Direct link to heading")

When enabled, the SDK will automatically perform a `Radar.trackOnce()` call when the app is launched or foregrounded.

### []()Start tracking on initialize[#](#start-tracking-on-initialize "Direct link to heading")

When enabled, the SDK will automatically start tracking with `Radar.startTracking()` when the app is launched.

### []()Log level[#](#log-level "Direct link to heading")

Set the SDK log level. Overrides any log level set client side.

## []()Remotely set tracking options[#](#remotely-set-tracking-options "Direct link to heading")
...
### []()Custom tracking options[#](#custom-tracking-options "Direct link to heading")
