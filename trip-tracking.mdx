...
### [Wrong destination arrival detection](#wrong-destination-arrival-detection)
...
### [Delay detection](#delay-detection)
...
## [Display live trips and ETAs](#display-live-trips-and-etas)

### [In the Radar trip tracking dashboard](#in-the-radar-trip-tracking-dashboard)
...
### [How to filter your data](#how-to-filter-your-data)
...
### [By Destination table](#by-destination-table)
...
### [Data retention settings and frequency of updates](#data-retention-settings-and-frequency-of-updates)
