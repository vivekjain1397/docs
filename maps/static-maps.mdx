...
### [Markers](#markers "Direct link to heading")
...
### [Paths](#paths "Direct link to heading")
...
### [Embedding a Radar Static Map using HTML](#embedding-a-radar-static-map-using-html "Direct link to heading")
...
### [Autofitting map bounds to markers or paths](#autofitting-map-bounds-to-markers-or-paths "Direct link to heading")
...
### [Using a custom marker image](#using-a-custom-marker-image "Direct link to heading")
...
### [Rendering a route](#rendering-a-route "Direct link to heading")
...
### [Images for high resolution device](#images-for-high-resolution-device "Direct link to heading")
