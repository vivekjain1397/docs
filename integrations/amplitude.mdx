...
On the Amplitude _Manage Project_ page, copy your API key.

Then, on the Radar [Integrations page](https://radar.com/dashboard/integrations) under _Amplitude_, set _Enabled_ to _Yes_ and paste your API key. Note that you can set separate API keys for the _Test_ and _Live_ environments.
