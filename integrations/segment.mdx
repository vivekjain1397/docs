---
title: "Segment"
description: "The Segment integration is available on the ."
---
...
```
// track logged out users with custom anonymousId mapping (not required if using default mapping)Radar.setMetadata(["segmentAnonymousId": anonymousId])
// track logged in users with custom userId mapping (not required if using default mapping)Radar.setMetadata(["segmentUserId": userId])
```
...
### []()Geofence Entered[#](#geofence-entered "Direct link to heading")
...
### []()Geofence Exited[#](#geofence-exited "Direct link to heading")
...
### []()Dwelled in Geofence[#](#dwelled-in-geofence "Direct link to heading")
...
### []()Place Entered[#](#place-entered "Direct link to heading")
...
### []()Place Exited[#](#place-exited "Direct link to heading")
...
### []()Country Entered[#](#country-entered "Direct link to heading")
...
### []()Country Exited[#](#country-exited "Direct link to heading")
...
### []()State Entered[#](#state-entered "Direct link to heading")
...
### []()State Exited[#](#state-exited "Direct link to heading")
...
### []()DMA Entered[#](#dma-entered "Direct link to heading")
...
### []()DMA Exited[#](#dma-exited "Direct link to heading")
...
### []()Trip Started[#](#trip-started "Direct link to heading")
...
### []()Trip Updated[#](#trip-updated "Direct link to heading")
...
### []()Trip Approaching Destination[#](#trip-approaching-destination "Direct link to heading")
...
### []()Trip Arrived Destination[#](#trip-arrived-destination "Direct link to heading")
...
### []()Trip Stopped[#](#trip-stopped "Direct link to heading")
...
### []()Beacon Entered[#](#beacon-entered "Direct link to heading")
...
### []()Beacon Exited[#](#beacon-exited "Direct link to heading")
