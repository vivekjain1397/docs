---
title: "Iterable"
description: "The Iterable integration is available on the ."
---
...
```
IterableApi.getInstance().setUserId(userId)val dataFields = JSONObject()dataFields.put("userId",userId)IterableApi.getInstance().updateUser(dataFields)
```
...
### []()Send a personalized push notification when user is near a store[#](#send-a-personalized-push-notification-when-user-is-near-a-store "Direct link to heading")
...
#### []()Configure geofences in Radar[#](#configure-geofences-in-radar "Direct link to heading")
...
#### []()Create a new Journey in Iterable[#](#create-a-new-journey-in-iterable "Direct link to heading")
...
#### []()Set up a push notification template in Iterable[#](#set-up-a-push-notification-template-in-iterable "Direct link to heading")
...
#### []()Test your campaign[#](#test-your-campaign "Direct link to heading")
...
### []()Filter users in an Iterable Journey whose last known location is X minutes away from a store[#](#filter-users-in-an-iterable-journey-whose-last-known-location-is-x-minutes-away-from-a-store "Direct link to heading")
...
#### []()Configure geofences in Radar[#](#configure-geofences-in-radar-1 "Direct link to heading")
...
#### []()Create a new Journey in Iterable[#](#create-a-new-journey-in-iterable-1 "Direct link to heading")
...
#### []()Set up a push notification template in Iterable[#](#set-up-a-push-notification-template-in-iterable-1 "Direct link to heading")
...
#### []()Test your campaign[#](#test-your-campaign-1 "Direct link to heading")
...
### []()radarGeofenceEntered[#](#radargeofenceentered "Direct link to heading")
...
### []()radarGeofenceExited[#](#radargeofenceexited "Direct link to heading")
...
### []()radarDwelledInGeofence[#](#radardwelledingeofence "Direct link to heading")
...
### []()radarPlaceEntered[#](#radarplaceentered "Direct link to heading")
...
### []()radarPlaceExited[#](#radarplaceexited "Direct link to heading")
...
### []()radarCountryEntered[#](#radarcountryentered "Direct link to heading")
...
### []()radarCountryExited[#](#radarcountryexited "Direct link to heading")
...
### []()radarStateEntered[#](#radarstateentered "Direct link to heading")
...
### []()radarStateExited[#](#radarstateexited "Direct link to heading")
...
### []()radarDMAEntered[#](#radardmaentered "Direct link to heading")
...
### []()radarDMAExited[#](#radardmaexited "Direct link to heading")
...
### []()radarTripStarted[#](#radartripstarted "Direct link to heading")
...
### []()radarApproachingTripDestination[#](#radarapproachingtripdestination "Direct link to heading")
...
### []()radarArrivedTripDestination[#](#radararrivedtripdestination "Direct link to heading")
...
### []()radarTripStopped[#](#radartripstopped "Direct link to heading")
...
### []()radarBeaconEntered[#](#radarbeaconentered "Direct link to heading")
...
### []()radarBeaconExited[#](#radarbeaconexited "Direct link to heading")
