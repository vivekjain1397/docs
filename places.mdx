---
title: "Places"
description: "Places is available on the ."
---
...
## [Confidence](#confidence "Direct link to heading")
...
## [Categories](#categories "Direct link to heading")
...
### [Mappings](#mappings "Direct link to heading")

To map Radar chain slugs to custom IDs, set *Chain mappings* under *Places* on the [Settings page](https://radar.com/dashboard/settings).
...
### [Metadata](#metadata "Direct link to heading")

To map Radar chain slugs to custom metadata, set *Chain metadata* under *Places* on the [Settings page](https://radar.com/dashboard/settings).
...
## [Place filters](#place-filters "Direct link to heading")

We recommend filtering events to specific categories or chains under *Places* on the [Settings page](https://radar.com/dashboard/settings).
...
## [State blocklist](#state-blocklist "Direct link to heading")

To suppress tracking specific place categories in certain states, set *Category state blocklist mapping* under *Places* on the [Settings page](https://radar.com/dashboard/settings).
...
## [Verify events](#verify-events "Direct link to heading")
...
## [Place matching](#place-matching "Direct link to heading")
...
### [Geofence types](#geofence-types "Direct link to heading")
