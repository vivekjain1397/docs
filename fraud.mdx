---
title: "Fraud"
description: "Fraud is available on the ."
---
...
![](/images/f2vbu16fzuly/1jClpoJtUsaRkaVKM8XDt9/7b2c4ed7b2a19183e2bff5711b22c444/fraud_event.svg)
...
## []()Fraud flags[#](#fraud-flags "Direct link to heading")
...
## []()Bypassing checks for testing[#](#bypassing-checks-for-testing "Direct link to heading")
...
## []()Blocking users[#](#blocking-users "Direct link to heading")
...
## []()Allowed states and countries[#](#allowed-states-and-countries "Direct link to heading")
...
## []()Platform-specific configuration[#](#platform-specific-configuration "Direct link to heading")
...
#### []()Play Integrity API[#](#play-integrity-api "Direct link to heading")
...
#### []()SSL pinning[#](#ssl-pinning "Direct link to heading")
...
#### []()App Attest[#](#app-attest "Direct link to heading")
...
#### []()SSL pinning[#](#ssl-pinning-1 "Direct link to heading")
...
### []()Web and desktop[#](#web-and-desktop "Direct link to heading")
...
## []()Verifying user locations[#](#verifying-user-locations "Direct link to heading")
...
### []()Manual location checks[#](#manual-location-checks "Direct link to heading")
...
### []()Automatic location checks with caching[#](#automatic-location-checks-with-caching "Direct link to heading")
...
Radar.startTrackingVerified(interval = 1200, beacons = false)
// get a cached token if available, or fetch a fresh token if notRadar.getVerifiedLocationToken { status, token ->  if (token?.passed == true) {    // allow access, send token to server  } else {    // deny access, show error message  }}
...
### []()Failure reasons[#](#failure-reasons "Direct link to heading")
...
## []()User and device risk scores[#](#user-and-device-risk-scores "Direct link to heading")
...
## []()Error handling[#](#error-handling "Direct link to heading")
...
[Edit this page](https://github.com/radarlabs/docs/edit/main/docs/fraud.mdx)
