---
title: "Testing"
description: "Use this guide to troubleshoot issues with location tracking and event generation."
---

## []()Device is not showing up in the dashboard[#](#device-is-not-showing-up-in-the-dashboard "Direct link to heading")
...
### []()Common issues[#](#common-issues "Direct link to heading")
...
### []()Troubleshooting steps[#](#troubleshooting-steps "Direct link to heading")
...
## []()Events are not firing when the app is backgrounded[#](#events-are-not-firing-when-the-app-is-backgrounded "Direct link to heading")
...
### []()Common issues[#](#common-issues-1 "Direct link to heading")
...
### []()Troubleshooting steps[#](#troubleshooting-steps-1 "Direct link to heading")
...
## []()Event listeners are not delivering[#](#event-listeners-are-not-delivering "Direct link to heading")

### []()Common issues[#](#common-issues-2 "Direct link to heading")

* Radar event listeners are not implemented correctly.
* Radar events are not generating from location updates.

### []()Troubleshooting steps[#](#troubleshooting-steps-2 "Direct link to heading")
...
## []()Troubleshooting other behavior[#](#troubleshooting-other-behavior "Direct link to heading")

### []()Multiple Radar users have the same user ID or device ID[#](#multiple-radar-users-have-the-same-user-id-or-device-id "Direct link to heading")
...
### []()Rate limit errors are occurring when tracking location[#](#rate-limit-errors-are-occurring-when-tracking-location "Direct link to heading")
...
## []()Simulator[#](#simulator "Direct link to heading")
...
## []()User Activity[#](#user-activity "Direct link to heading")
...
### []()How it works[#](#how-it-works-1 "Direct link to heading")
...
### []()Location sources[#](#location-sources "Direct link to heading")
