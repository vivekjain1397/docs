...
### [How should I test Radar battery drain?](#how-should-i-test-radar-battery-drain "Direct link to heading")
...
### [Can I test Radar side-by-side with another location SDK?](#can-i-test-radar-side-by-side-with-another-location-sdk "Direct link to heading")
...
### [Is Radar still able to track location in the background if the app is killed?](#is-radar-still-able-to-track-location-in-the-background-if-the-app-is-killed "Direct link to heading")
...
### [If a user backgrounds my app, do I need to request background location permissions to access location?](#if-a-user-backgrounds-my-app-do-i-need-to-request-background-location-permissions-to-access-location "Direct link to heading")
...
### [What are the different event listeners and how should I use them?](#what-are-the-different-event-listeners-and-how-should-i-use-them "Direct link to heading")
...
### [What is the latency of Radar APIs?](#what-is-the-latency-of-radar-apis "Direct link to heading")
...
### [How often are usage statistics recalculated?](#how-often-are-usage-statistics-recalculated "Direct link to heading")
...
## [Privacy](#privacy "Direct link to heading")

### [What data does the Radar SDK collect?](#what-data-does-the-radar-sdk-collect "Direct link to heading")
...
### [What are privacy best practices for Radar?](#what-are-privacy-best-practices-for-radar "Direct link to heading")
...
### [What are location permission prompt best practices?](#what-are-location-permission-prompt-best-practices "Direct link to heading")
...
### [What is Radar's data retention policy?](#what-is-radars-data-retention-policy "Direct link to heading")
...
### [Is Radar CCPA-compliant and GDPR-compliant?](#is-radar-ccpa-compliant-and-gdpr-compliant "Direct link to heading")
...
## [Security](#security "Direct link to heading")

### [How do Radar account roles work?](#how-do-radar-account-roles-work "Direct link to heading")
...
### [How do data access controls work?](#how-do-data-access-controls-work "Direct link to heading")

Data access controls are available on the [Enterprise plan](https://radar.com/pricing).
...
### [Does Radar have a bug bounty or responsible disclosure program?](#does-radar-have-a-bug-bounty-or-responsible-disclosure-program "Direct link to heading")

Yes. For more information, see the [Vulnerability Disclosure Policy](/vulnerability-disclosure-policy).

### [What are security best practices for Radar?](#what-are-security-best-practices-for-radar "Direct link to heading")

#### [Account management](#account-management "Direct link to heading")
...
#### [Website Restrictions](#website-restrictions "Direct link to heading")
...
#### [Mobile Restrictions](#mobile-restrictions "Direct link to heading")
...
#### [Data management](#data-management "Direct link to heading")
...
### [Does Radar support audit logs?](#does-radar-support-audit-logs "Direct link to heading")
...
### [How do I set up single sign-on (SSO) in Radar?](#how-do-i-set-up-single-sign-on-sso-in-radar "Direct link to heading")
...
#### [SAML](#saml "Direct link to heading")
...
* User ID attribute (defaults to [http://schemas.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier](http://schemas.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier) then [http://schemas.xmlsoap.org/ws/2005/05/identity/claims/upn](http://schemas.xmlsoap.org/ws/2005/05/identity/claims/upn) then [http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name](http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name))

### [Is Radar SOC 2 type II-certified?](#is-radar-soc-2-type-ii-certified "Direct link to heading")
...
### [Is the Radar SDK secure?](#is-the-radar-sdk-secure "Direct link to heading")
...
## [Location permissions](#location-permissions "Direct link to heading")

### [How do I get statistics for location permissions?](#how-do-i-get-statistics-for-location-permissions "Direct link to heading")

Statistics for location permissions are available for customers who have installed SDK 3.1 or later.

### [What do the states in the location permissions graph represent?](#what-do-the-states-in-the-location-permissions-graph-represent "Direct link to heading")
...
### [What is a tracked user?](#what-is-a-tracked-user "Direct link to heading")

A tracked user is a unique user that sends one or more location events to Radar in a given time period.

### [What is a unique user? When does Radar create a new user record?](#what-is-a-unique-user-when-does-radar-create-a-new-user-record "Direct link to heading")
...
### [What is an active user?](#what-is-an-active-user "Direct link to heading")

An active user is a unique user that has an [app session](#what-qualifies-as-an-app-session) in a given time period.

### [What qualifies as an app session?](#what-qualifies-as-an-app-session "Direct link to heading")
...
### [Why are counts of active users different from counts of tracked users?](#why-are-counts-of-active-users-different-from-counts-of-tracked-users "Direct link to heading")
...
[Edit this page](https://github.com/radarlabs/docs/edit/main/docs/faqs.mdx)
