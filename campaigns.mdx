...
## []()Campaign types[#](#campaign-types "Direct link to heading")

### []()Client side geofence[#](#client-side-geofence "Direct link to heading")
...
## []()Targeting options[#](#targeting-options "Direct link to heading")
...
## []()Notification configurations[#](#notification-configurations "Direct link to heading")
...
## []()Frequency Capping[#](#frequency-capping "Direct link to heading")
...
## []()Analytics (iOS only)[#](#analytics-ios-only "Direct link to heading")
...
You can view these campaign conversion analytics by pressing the analytics button on the campaign's page. Alternatively, you can navigate to Geofencing -> Analytics -> Events -> Filters (top right) -> select Type as *opened\_app* -> Apply Filters. From there, select *campaign\_name* from the *grouped\_by* dropdown. See screenshot below: ![OnPremiseNotifications](/images/assets/images/conversion_source_analytics-4a52cd8a87055b91f37bebaecc7f5f16.png)

### []()Automated iOS setup[#](#automated-ios-setup "Direct link to heading")
...
### []()Manual iOS setup[#](#manual-ios-setup "Direct link to heading")
...
## []()Deep linking (iOS only)[#](#deep-linking-ios-only "Direct link to heading")
...
### []()Automated iOS setup[#](#automated-ios-setup-1 "Direct link to heading")
...
### []()Manual iOS setup[#](#manual-ios-setup-1 "Direct link to heading")
...
### []()Automated React Native setup (iOS only)[#](#automated-react-native-setup-ios-only "Direct link to heading")
...
### []()Handle system deep link[#](#handle-system-deep-link "Direct link to heading")
