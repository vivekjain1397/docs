---
title: "API Reference"
description: "Use Radar APIs as  like pickup and delivery tracking, location-triggered notifications, location verification, store locators, address autocomplete, and more. Or, use Radar APIs to , including users, geofences, and events."
---
...
###### []()Sample request[#](#sample-request "Direct link to heading")

```
curl https://api.radar.io/v1/users \  -H "Authorization: prj_live_sk_..."
```

Copy

## []()Errors[#](#errors "Direct link to heading")

The API uses standard HTTP response codes.

###### []()Response codes[#](#response-codes "Direct link to heading")
...
###### []()Sample error response[#](#sample-error-response "Direct link to heading")

```
{  "meta": {    "code": 400,    "param": "latitude",    "message": "latitude: Invalid latitude. Valid range: [-90, 90]."  }}
```

Copy

## []()Building blocks[#](#building-blocks "Direct link to heading")
...
###### []()Body parameters[#](#body-parameters "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level "Direct link to heading")
...
###### []()Sample request[#](#sample-request-1 "Direct link to heading")

```
curl "https://api.radar.io/v1/track" \  -H "Authorization: prj_live_pk_..." \  -X POST \  -d "deviceId=C305F2DB-56DC-404F-B6C1-BC52F0B680D8" \  -d "userId=1" \  -d "latitude=40.78382" \  -d "longitude=-73.97536" \  -d "accuracy=65"
```

Copy

###### []()Sample response[#](#sample-response "Direct link to heading")
...
###### []()Query parameters[#](#query-parameters "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-1 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit "Direct link to heading")

10 requests per second

###### []()Sample request[#](#sample-request-2 "Direct link to heading")

```
curl "https://api.radar.io/v1/context?coordinates=40.78382,-73.97536" \  -H "Authorization: prj_live_pk_..."
```

Copy

###### []()Sample response[#](#sample-response-1 "Direct link to heading")
...
#### []()Forward geocode[#](#forward-geocode "Direct link to heading")
...
###### []()Definitions[#](#definitions-1 "Direct link to heading")

GET `https://api.radar.io/v1/geocode/forward`

###### []()Query parameters[#](#query-parameters-1 "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-2 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-1 "Direct link to heading")

10 requests per second (contact your customer success manager to increase rate limit)

###### []()Sample request[#](#sample-request-3 "Direct link to heading")
...
###### []()Sample response[#](#sample-response-2 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "addresses": [    {      "latitude": 40.7041,      "longitude": -73.9867,      "geometry": {        "type": "Point",        "coordinates": [-73.9867,40.7041]      },      "country": "United States",      "countryCode": "US",      "countryFlag": "🇺🇸",      "county": "Kings County",      "confidence": "exact",      "borough": "Brooklyn",      "city": "Brooklyn",      "number": "20",      "neighborhood": "DUMBO",      "postalCode": "11201",      "stateCode": "NY",      "state": "New York",      "street": "Jay St",      "layer": "address",      "formattedAddress": "20 Jay St, Brooklyn, New York, NY 11201 USA",      "addressLabel": "20 Jay St",      "timeZone": {        "id": "America/New_York",        "name": "Eastern Daylight Time",        "code": "EDT",        "currentTime": "2024-04-09T10:12:00-04:00",        "utcOffset": -14400,        "dstOffset": 3600      }    }  ]}
```

Copy

#### []()Reverse geocode[#](#reverse-geocode "Direct link to heading")

Reverse geocodes a location, converting coordinates to address.

###### []()Definitions[#](#definitions-2 "Direct link to heading")

GET `https://api.radar.io/v1/geocode/reverse`

###### []()Query parameters[#](#query-parameters-2 "Direct link to heading")

* **`coordinates`** (string, required): The coordinates to reverse geocode. A string in the format `latitude,longitude`.
* **`layers`** (string, optional): Optional layer filters. A string, comma-separated, including one or more of `place`, `address`, `postalCode`, `locality`, `county`, `state`, `country`, `coarse`, and `fine`. Note that `coarse` includes all of `postalCode`, `locality`, `county`, `state`, and `country`, whereas `fine` includes `address` and `place`. If not provided, results from `address` and `coarse` layers will be returned.

###### []()Authentication level[#](#authentication-level-3 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-2 "Direct link to heading")

10 requests per second (contact your customer success manager to increase rate limit)

###### []()Sample request[#](#sample-request-4 "Direct link to heading")

```
curl "https://api.radar.io/v1/geocode/reverse?coordinates=40.70390,-73.98670" \  -H "Authorization: prj_live_pk_..."
```

Copy

###### []()Sample responses[#](#sample-responses "Direct link to heading")

```
{  "meta": {    "code": 200  },  "addresses": [    {      "latitude": 40.70390,      "longitude": -73.98670,      "geometry": {        "type": "Point",        "coordinates": [-73.98670, 40.70390]      },      "addressLabel": "20 Jay Street",      "formattedAddress": "20 Jay Street, Brooklyn, New York, NY 11201 USA",      "country": "United States",      "countryCode": "US",      "countryFlag": "🇺🇸",      "state": "New York",      "stateCode": "NY",      "postalCode": "11201",      "city": "New York",      "borough": "Brooklyn",      "county": "Kings County",      "neighborhood": "DUMBO",      "timeZone": {        "id": "America/New_York",        "name": "Eastern Daylight Time",        "code": "EDT",        "currentTime": "2024-04-09T10:12:00-04:00",        "utcOffset": -14400,        "dstOffset": 3600      },      "number": "20",      "distance": 5,      "layer": "address"    }  ]}
```

Copy

#### []()IP geocode[#](#ip-geocode "Direct link to heading")

Geocodes the requester's IP, converting IP address to city, state, and country.

###### []()Definitions[#](#definitions-3 "Direct link to heading")

GET `https://api.radar.io/v1/geocode/ip`

###### []()Authentication level[#](#authentication-level-4 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-3 "Direct link to heading")

10 requests per second per device

###### []()Sample request[#](#sample-request-5 "Direct link to heading")

```
curl "https://api.radar.io/v1/geocode/ip" \  -H "Authorization: prj_live_pk_..."
```

Copy

###### []()Sample response[#](#sample-response-3 "Direct link to heading")
...
#### []()Autocomplete[#](#autocomplete "Direct link to heading")

Autocompletes partial addresses and place names, sorted by relevance and proximity.

###### []()Definitions[#](#definitions-4 "Direct link to heading")

GET `https://api.radar.io/v1/search/autocomplete`

###### []()Query parameters[#](#query-parameters-3 "Direct link to heading")
...
###### []()Query best practices[#](#query-best-practices "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-5 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-4 "Direct link to heading")

10 requests per second (contact your customer success manager to increase rate limit)

###### []()Sample request[#](#sample-request-6 "Direct link to heading")

```
curl "https://api.radar.io/v1/search/autocomplete?query=brooklyn+roasting&near=40.70390,-73.98670" \  -H "Authorization: prj_live_pk_..."
```

Copy

###### []()Sample response[#](#sample-response-4 "Direct link to heading")
...
#### []()Search users[#](#search-users "Direct link to heading")

Searches for users near a location, sorted by distance.

###### []()Definitions[#](#definitions-5 "Direct link to heading")

GET `https://api.radar.io/v1/search/users`

###### []()Query parameters[#](#query-parameters-4 "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-6 "Direct link to heading")

Secret

###### []()Default rate limit[#](#default-rate-limit-5 "Direct link to heading")

100 requests per second

###### []()Sample request[#](#sample-request-7 "Direct link to heading")

```
curl "https://api.radar.io/v1/search/users?near=40.78382,-73.97536&radius=1000&limit=10" \  -H "Authorization: prj_live_sk_..."
```

Copy

###### []()Sample response[#](#sample-response-5 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "users": [    {      "_id": "56db1f4613012711002229f4",      "live": true,      "userId": "1",      "deviceId": "C305F2DB-56DC-404F-B6C1-BC52F0B680D8",      ...    },    ...  ]}
```

Copy

#### []()Search geofences[#](#search-geofences "Direct link to heading")

Searches for geofences near a location, sorted by distance.

###### []()Definitions[#](#definitions-6 "Direct link to heading")

GET `https://api.radar.io/v1/search/geofences`

###### []()Query parameters[#](#query-parameters-5 "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-7 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-6 "Direct link to heading")

100 requests per second

###### []()Sample request[#](#sample-request-8 "Direct link to heading")

```
curl "https://api.radar.io/v1/search/geofences?tags=store&metadata%5Boffers%5D=true&near=40.783826,-73.975363&radius=1000&limit=10" \  -H "Authorization: prj_live_pk_..."
```

Copy

###### []()Sample response[#](#sample-response-6 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "geofences": [    {      "_id": "56db1f4613012711002229f5",      "createdAt": "2016-06-10T13:44:10.535Z",      "live": true,      "tag": "store",      "externalId": "123",      "description": "Store #123",      "metadata": {        "rating": "4.5"      },      "geometryCenter": {        "type": "Point",        "coordinates": [-73.97536, 40.78382]      },      ...    },    ...  ]}
```

Copy

#### []()Search places[#](#search-places "Direct link to heading")

Searches for places near a location, sorted by distance.

###### []()Definitions[#](#definitions-7 "Direct link to heading")

GET `https://api.radar.io/v1/search/places`

###### []()Query parameters[#](#query-parameters-6 "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-8 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-7 "Direct link to heading")

150 requests per second

###### []()Sample request[#](#sample-request-9 "Direct link to heading")

```
curl "https://api.radar.io/v1/search/places?chains=starbucks&near=40.78382,-73.97779&radius=1000&limit=10" \  -H "Authorization: prj_live_pk_..."
```

Copy

###### []()Sample response[#](#sample-response-7 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "places": [    {      "name": "Starbucks",      "chain": {        "name": "Starbucks",        "slug": "starbucks",        "externalId": "123",        "metadata": {          "customFlag": true        }      },      "categories": [        "food-beverage",        "coffee-shop"      ],      "location": {        "type": "Point",        "coordinates": [          -73.97779,          40.78382        ]      }    },    ...  ]}
```

Copy

#### []()Validate an address[#](#validate-an-address "Direct link to heading")
...
###### []()Definitions[#](#definitions-8 "Direct link to heading")

GET `https://api.radar.io/v1/addresses/validate`

###### []()Query parameters[#](#query-parameters-7 "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-9 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-8 "Direct link to heading")

100 requests per second

###### []()Sample request[#](#sample-request-10 "Direct link to heading")

```
curl "https://api.radar.io/v1/addresses/validate?countryCode=US&stateCode=NY&city=New%20York&number=841&postalCode=10003&street=Broadway&unit=Fl%7" \  -H "Authorization: prj_live_pk_..."
```

Copy

###### []()Sample response[#](#sample-response-8 "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-10 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-9 "Direct link to heading")

100 requests per second

###### []()Sample request[#](#sample-request-11 "Direct link to heading")

```
curl "https://api.radar.io/v1/route/distance?origin=40.78382,-73.97536&destination=40.70390,-73.98690&modes=foot,car&units=imperial" \  -H "Authorization: prj_live_pk_..."
```

Copy

###### []()Sample response[#](#sample-response-9 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "routes": {    "geodesic": {      "distance": {        "value": 29333.03,        "text": "5.6 mi"      }    },    "foot": {      "distance": {        "value": 54596.46,        "text": "10.3 mi",      },      "duration": {        "value": 98.48,        "text": "1 hr 38 min"      }    },    "car": {      "distance": {        "value": 42480.31,        "text": "8.0 mi"      },      "duration": {        "value": 19.9,        "text": "20 mins"      }    }  }}
```
...
###### []()Definitions[#](#definitions-10 "Direct link to heading")

GET `https://api.radar.io/v1/route/matrix`

###### []()Query parameters[#](#query-parameters-9 "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-11 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-10 "Direct link to heading")

20 requests per second

###### []()Sample request[#](#sample-request-12 "Direct link to heading")

```
curl "https://api.radar.io/v1/route/matrix?origins=40.78382,-73.97536&destinations=40.70390,-73.98690|40.73237,-73.94884&mode=car&units=imperial" \  -H "Authorization: prj_live_pk_..."
```

Copy

###### []()Sample response[#](#sample-response-10 "Direct link to heading")
...
#### []()Route match[#](#route-match "Direct link to heading")
...
###### []()Definitions[#](#definitions-11 "Direct link to heading")

POST `https://api.radar.io/v1/route/match`

###### []()JSON payload[#](#json-payload "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-12 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-11 "Direct link to heading")

10 requests per second (contact your customer success manager to increase rate limit)

###### []()Sample request[#](#sample-request-13 "Direct link to heading")
...
###### []()Sample response[#](#sample-response-11 "Direct link to heading")
...
###### []()Response Definitions[#](#response-definitions "Direct link to heading")
...
#### []()Directions[#](#directions "Direct link to heading")

Calculates the most efficient route between two or more locations to visit in order.

###### []()Definitions[#](#definitions-12 "Direct link to heading")

GET `https://api.radar.io/v1/route/directions`

###### []()Query parameters[#](#query-parameters-10 "Direct link to heading")
...
###### []()Turn by Turn[#](#turn-by-turn "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-13 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-12 "Direct link to heading")

10 requests per second (contact your customer success manager to increase rate limit)

###### []()Sample request[#](#sample-request-14 "Direct link to heading")

```
curl "https://api.radar.io/v1/route/directions?locations=40.734250,-73.990934|40.712971,-73.951385|40.745580,-73.903162|40.774419,-73.872746&mode=car&units=imperial" \  -H "Authorization: prj_live_pk_..."
```

Copy

###### []()Sample response[#](#sample-response-12 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "routes": [    {      "duration": {        "value": 39.36884333333333,        "text": "39 mins"      },      "distance": {        "value": 74156.82651999999,        "text": "14.0 mi"      },      "legs": [        {          "startLocation": {            "latitude": 40.73425,            "longitude": -73.990934          },          "endLocation": {            "latitude": 40.712971,            "longitude": -73.951385          },          "duration": {            "value": 15.764213333333332,            "text": "16 mins"          },          "distance": {            "value": 19937.66468,            "text": "3.8 mi"          },          "geometry": {            "polyline": "kafulAnn`clCfKxAhCF`CJdg@vGtB\\|BZfJrAh[lEhC^dBThMjBjRjCdBZn@Pd@Nh@Pf@Vf@Vh@`@vWxSv@l@t@l@`BpArB`BtYjU~AlAbBtA`BzAdVnQfEhD`ClBhRfOlCxBjBxAhBxAxKzItNhL|BhBnB|Af]rXnB~A|AnAn[fWbAv@~ArAzBfBxStPbInGtB`BlBzA~b@l]bAx@d@\\jBxAjMdKTPxGlFnJvH|StPnCxBhFbEr@{EfEeYvCyRf@kD\\{BBUtC}RfAoFbAcFpDsNh@qBp@oCfLcd@r@sCn@cC`Lsc@p@kCl@aCjE}P`E}O^cBhAgFvDbAd@L~fAtYhTrF~Ab@tBh@rA\\bd@vLvA^|Ab@`B^f`@dLxAf@lBl@xAd@tF~AxPzEpBl@tF~AnAmFpBsD~BkE`DyNlGmY^cBjA_G`AwEX}AnG}Zd@}B~@uEj@uCtKyh@XsAh@gCd@yBbJ{c@\\aBr@iD~AeIz@yDn@wCpD}PVmAf@eCf@eC`Joc@VsAf@aCd@}BpHm^r@kDXoAfAkFbA{EtIsb@Z}A`@uBR_AXeAd@}A`AwCtEsNrAsEjAeEb@aBd@aBr@sCz@cDjBcHbIoY|@kD\\qAXkAxDgRzAmHzSgdA~J_g@|\\gcBpb@_uB|U{kAdIcTdVqpAl~DssRj_@{hB|Fq_@zt@opDtG_UrEcU`AoFjCkOd@yC`@}CToCTwChAeTx@}PRkCb@eDd@gCn@sCrP_r@\\uAjAuEmCuAsP}I}KsG}@i@kAq@QeFo@uTAMiBy_@wBac@KkBMsBSaDk@mIs@{Io@aMmBs]{AmXS}EQ{CoBac@OeDeA{ScAoTUmEUeEsA{X}@yPoEi~@WkF}AcPScFG}AUkFaDXm[fCgKv@aCRec@hD_CP{CZo]bD"          },          "steps": [            {              "distance": {                "value": 3674.5407999999998,                "text": "0.7 mi"              },              "duration": {                "value": 2.1034166666666665,                "text": "2 mins"              },              "start_location": {                "latitude": 40.734246,                "longitude": -73.990904              },              "end_location": {                "latitude": 40.725384,                "longitude": -73.996813              },              "instructions": "Drive south on Broadway.",              "geometry": {                "polyline": "kafulAnn`clCfKxAhCF`CJdg@vGtB\\|BZfJrAh[lEhC^dBThMjBjRjCdBZn@Pd@Nh@Pf@Vf@Vh@`@vWxSv@l@t@l@`BpArB`BtYjU~AlAbBtA`BzAdVnQfEhD`ClBhRfOlCxBjBxAhBxAxKzItNhL|BhBnB|Af]rXnB~A|AnAn[fWbAv@~ArAzBfBxStPbInGtB`BlBzA~b@l]bAx@d@\\jBxAjMdKTPxGlFnJvH|StPnCxBhFbE"              },              "travel_mode": "DRIVE",              "manuever": "start"            },            {              "distance": {                "value": 1233.59584,                "text": "0.2 mi"              },              "duration": {                "value": 0.8153,                "text": "1 min"              },              "start_location": {                "latitude": 40.725384,                "longitude": -73.996813              },              "end_location": {                "latitude": 40.724094,                "longitude": -73.992697              },              "instructions": "Turn left onto East Houston Street.",              "geometry": {                "polyline": "owttlAx_lclCr@{EfEeYvCyRf@kD\\{BBUtC}RfAoFbAcFpDsNh@qBp@oCfLcd@r@sCn@cC`Lsc@p@kCl@aCjE}P`E}O^cBhAgF"              },              "travel_mode": "DRIVE",              "manuever": "left"            },            {              "distance": {                "value": 1420.60372,                "text": "0.3 mi"              },              "duration": {                "value": 0.7290833333333333,                "text": "1 min"              },              "start_location": {                "latitude": 40.724094,                "longitude": -73.992697              },              "end_location": {                "latitude": 40.720342,                "longitude": -73.994113              },              "instructions": "Turn right onto Bowery.",              "geometry": {                "polyline": "{frtlAp~cclCvDbAd@L~fAtYhTrF~Ab@tBh@rA\\bd@vLvA^|Ab@`B^f`@dLxAf@lBl@xAd@tF~AxPzEpBl@tF~A"              },              "travel_mode": "DRIVE",              "manuever": "right"            },            {              "distance": {                "value": 4573.49096,                "text": "0.9 mi"              },              "duration": {                "value": 1.9212833333333335,                "text": "2 mins"              },              "start_location": {                "latitude": 40.720342,                "longitude": -73.994113              },              "end_location": {                "latitude": 40.715536,                "longitude": -73.978895              },              "instructions": "Turn left onto Delancey Street.",              "geometry": {                "polyline": "k|jtlA`wfclCnAmFpBsD~BkE`DyNlGmY^cBjA_G`AwEX}AnG}Zd@}B~@uEj@uCtKyh@XsAh@gCd@yBbJ{c@\\aBr@iD~AeIz@yDn@wCpD}PVmAf@eCf@eC`Joc@VsAf@aCd@}BpHm^r@kDXoAfAkFbA{EtIsb@Z}A`@uBR_AXeAd@}A`AwCtEsNrAsEjAeEb@aBd@aBr@sCz@cDjBcHbIoY|@kD\\qAXkAxDgRzAmHzSgdA~J_g@|\\gcBpb@_uB|U{kA"              },              "travel_mode": "DRIVE",              "manuever": "left"            },            {              "distance": {                "value": 5000.00016,                "text": "0.9 mi"              },              "duration": {                "value": 1.63395,                "text": "2 mins"              },              "start_location": {                "latitude": 40.715536,                "longitude": -73.978895              },              "end_location": {                "latitude": 40.710432,                "longitude": -73.962139              },              "instructions": "Keep right to take Broadway toward I 278 West, Staten Island.",              "geometry": {                "polyline": "_patlA|_iblCdIcTdVqpAl~DssRj_@{hB|Fq_@zt@opD"              },              "travel_mode": "DRIVE",              "manuever": "stay-right"            },            {              "distance": {                "value": 213.2546,                "text": "213.3 ft"              },              "duration": {                "value": 0.07121666666666666,                "text": "0.1 min"              },              "start_location": {                "latitude": 40.710432,                "longitude": -73.962139              },              "end_location": {                "latitude": 40.710187,                "longitude": -73.961433              },              "instructions": "Take the exit on the right toward I 278 West, Broadway West. Then Keep left toward Broadway East.",              "geometry": {                "polyline": "_qwslAthhalCtG_UrEcU"              },              "travel_mode": "DRIVE",              "manuever": "exit-right"            },            {              "distance": {                "value": 757.87404,                "text": "757.9 ft"              },              "duration": {                "value": 0.4671666666666667,                "text": "0.5 min"              },              "start_location": {                "latitude": 40.710187,                "longitude": -73.961433              },              "end_location": {                "latitude": 40.709554,                "longitude": -73.95886              },              "instructions": "Keep left toward Broadway East, South 5th Street.",              "geometry": {                "polyline": "uawslAp|falC`AoFjCkOd@yC`@}CToCTwChAeTx@}PRkCb@eDd@gCn@sCrP_r@\\uAjAuE"              },              "travel_mode": "DRIVE",              "manuever": "stay-left"            },            {              "distance": {                "value": 259.18636,                "text": "259.2 ft"              },              "duration": {                "value": 0.15403333333333336,                "text": "0.2 min"              },              "start_location": {                "latitude": 40.709554,                "longitude": -73.95886              },              "end_location": {                "latitude": 40.710183,                "longitude": -73.958458              },              "instructions": "Turn left onto Havemeyer Street. Then Turn right onto Borinquen Place.",              "geometry": {                "polyline": "czuslAv{aalCmCuAsP}I}KsG}@i@kAq@"              },              "travel_mode": "DRIVE",              "manuever": "left"            },            {              "distance": {                "value": 2050.525,                "text": "0.4 mi"              },              "duration": {                "value": 0.93725,                "text": "1 min"              },              "start_location": {                "latitude": 40.710183,                "longitude": -73.958458              },              "end_location": {                "latitude": 40.710961,                "longitude": -73.951119              },              "instructions": "Turn right onto Borinquen Place.",              "geometry": {                "polyline": "mawslArbaalCQeFo@uTAMiBy_@wBac@KkBMsBSaDk@mIs@{Io@aMmBs]{AmXS}EQ{CoBac@OeDeA{ScAoTUmEUeEsA{X}@yPoEi~@WkF}AcPScFG}AUkF"              },              "travel_mode": "DRIVE",              "manuever": "right"            },            {              "distance": {                "value": 734.90816,                "text": "734.9 ft"              },              "duration": {                "value": 0.4403166666666667,                "text": "0.4 min"              },              "start_location": {                "latitude": 40.710961,                "longitude": -73.951119              },              "end_location": {                "latitude": 40.712967,                "longitude": -73.951428              },              "instructions": "Turn left onto Union Avenue.",              "geometry": {                "polyline": "arxslA|wr`lCaDXm[fCgKv@aCRec@hD_CP{CZo]bD"              },              "travel_mode": "DRIVE",              "manuever": "left"            },            {              "distance": {                "value": 0,                "text": "0.0 ft"              },              "duration": {                "value": 0,                "text": "0 min"              },              "start_location": {                "latitude": 40.712967,                "longitude": -73.951428              },              "end_location": {                "latitude": 40.712967,                "longitude": -73.951428              },              "instructions": "You have arrived at your destination.",              "geometry": {                "polyline": "mo|slAfks`lC"              },              "travel_mode": "DRIVE",              "manuever": "destination"            }          ]        },        {          "startLocation": {            "latitude": 40.712971,            "longitude": -73.951385          },          "endLocation": {            "latitude": 40.74558,            "longitude": -73.903162          },          "duration": {            "value": 15.217113333333334,            "text": "15 mins"          },          "distance": {            "value": 37089.8962,            "text": "7.0 mi"          },          "geometry": {            "polyline": "mo|slAfks`lCyGn@}k@pFgIj@wCR?jG@jX@bY@vJ?lEAnEEpX?zCAdKA~GGva@vDdBjM~G~DpBdCpAd[~OrMxG~DGbN|EdZjOvUhKhQvInPnFfOjDxYnFzNlEhQbHviAhi@d{Axs@tW~LfyBldAv`@fSll@fZtB|E~m@x\\fUhMzNhKjTnRvHfEbDvAtDyChWwZ|BkC}D{AmPoGcc@uJmSmFqh@kPcf@aUoiA_i@evBcbA_]}PwuAkp@cBy@qSmKmCuAmq@y`@sXcPa]{RkO}IeyAk{@cTaNkSaOgQsO{HcIyu@ew@g_@{d@ya@{j@e`@km@w]ml@ckAqsBe}@y`Bsc@e{@gd@g|@iPk\\oSyb@aQk^mNmZkCsFoCsFkCiFgC{EuCaFoCwEmCqEyh@{x@gDkFmCkEoCwEgCuEiCeFcC_FaCiF{^ky@uDgI}BqF_CwFqCiHgCaHqB{FmBiGsAgFcBoGyAgGqAyFqAcGeAkFyAiIgBsKiHsd@mPg_AaFw\\wD{V{Ms|@_AsGeAsGcAkGeA{FmAqGuA{GsAyFuAkGyAuF}AwFeBmFwB{GmBuFiBaFqBeF}BuFoBeE_CaFqCsF_CwE}BaE}CaFuCqE_DwEgCqDeCyCqDaF}CqDkCaDsE{FgkB_|B}DmEaEaEwDwD_E}DyDuD{DoD}EiEwE{D_FeEyEuDmFwDqF{DwGqEsFmD{FmDyqC}_BsDyBwDaCqCqBeDgCkDqCkDuC_DuCqDmDkDsDyDkEaD{DoDaFsDyF}CgFkCuEiCsEyBwE}B{EoBoEuBmFuJo\\y@gCyDqMcDyLgEwMqBoJmB_JkBsImAcHaBiJmAoHiA{GcAwG}@iGu@uFw@{Gw@mGu@qHs@sH_A{L{@uQeAcQy@yPo@qPi@iQ_Bml@[aPu@kQ_AiP}}@s{McB}Wi@mHs@qHu@wHm@eFy@uG{@eGaAsGaAeGkAoGkAcGuAoGuAeGsAuFaBeGaByFcBuFmB}Fwd@{sAqEqM}E_OsE_OwDoM_@wAcCiJy@{CSw@uBcIcHmXeUi|@kB}GwAoF}AsF}AiFmBwF{BaGsBiF{BqF_CiFuBuEeCgFaCqEoCcFwCeFoDqFcHeKq|@}jA}M}PktA{gBom@}w@}R}WaLqMcF{E_GkF{FeEoEyC{DoCmEaC{DeBeGsBsFwAkFiA}GgAmF_@wEMeF?sFL}EZcE`@{Ej@cF|@wDr@iEdAuElAoEnAeTnDaKlEuIjDaNjFyEhB{MtFyMtFeOdIuFhAq@Ly@Aq@So@_@m@w@e@gA]oAkAiFtEmNdUqp@rIwYvAmEfFk@zQqBbb@wENApDa@dAbUpAjYpCvh@tAhW|Dnw@|Ddw@zDjv@rAbXxAvXPnDZnGjDzr@NxCRbEvDlu@NnCP`EvDhz@pEf_A"          },          "steps": [            {              "distance": {                "value": 406.82416,                "text": "406.8 ft"              },              "duration": {                "value": 0.18710000000000002,                "text": "0.2 min"              },              "start_location": {                "latitude": 40.712967,                "longitude": -73.951428              },              "end_location": {                "latitude": 40.714067,                "longitude": -73.951605              },              "instructions": "Drive north on Union Avenue. Then, in 100 meters, Turn left onto Metropolitan Avenue.",              "geometry": {                "polyline": "mo|slAfks`lCyGn@}k@pFgIj@wCR"              },              "travel_mode": "DRIVE",              "manuever": "start"            },            {              "distance": {                "value": 757.87404,                "text": "757.9 ft"              },              "duration": {                "value": 0.41185,                "text": "0.4 min"              },              "start_location": {                "latitude": 40.714067,                "longitude": -73.951605              },              "end_location": {                "latitude": 40.714074,                "longitude": -73.95434              },              "instructions": "Turn left onto Metropolitan Avenue.",              "geometry": {                "polyline": "et~slAhvs`lC?jG@jX@bY@vJ?lEAnEEpX?zCAdKA~GGva@"              },              "travel_mode": "DRIVE",              "manuever": "left"            },            {              "distance": {                "value": 469.16012,                "text": "469.2 ft"              },              "duration": {                "value": 0.22013333333333335,                "text": "0.2 min"              },              "start_location": {                "latitude": 40.714074,                "longitude": -73.95434              },              "end_location": {                "latitude": 40.712904,                "longitude": -73.955046              },              "instructions": "Turn left onto Marcy Avenue. Then Bear left toward I 278 West.",              "geometry": {                "polyline": "st~slAfay`lCvDdBjM~G~DpBdCpAd[~OrMxG"              },              "travel_mode": "DRIVE",              "manuever": "left"            },            {              "distance": {                "value": 3645.0132399999998,                "text": "0.7 mi"              },              "duration": {                "value": 0.8754333333333334,                "text": "1 min"              },              "start_location": {                "latitude": 40.712904,                "longitude": -73.955046              },              "end_location": {                "latitude": 40.703669,                "longitude": -73.959976              },              "instructions": "Bear left toward I 278 West, Brooklyn-Queens Expressway.",              "geometry": {                "polyline": "ok|slAjmz`lC~DGbN|EdZjOvUhKhQvInPnFfOjDxYnFzNlEhQbHviAhi@d{Axs@tW~LfyBldAv`@fSll@fZ"              },              "travel_mode": "DRIVE",              "manuever": "slight-left"            },            {              "distance": {                "value": 843.17588,                "text": "843.2 ft"              },              "duration": {                "value": 0.19875,                "text": "0.2 min"              },              "start_location": {                "latitude": 40.703669,                "longitude": -73.959976              },              "end_location": {                "latitude": 40.701668,                "longitude": -73.961446              },              "instructions": "Take exit 31 on the right toward Wythe Avenue, Kent Avenue. Then Turn left onto Wythe Avenue.",              "geometry": {                "polyline": "ijjslAnadalCtB|E~m@x\\fUhMzNhKjTnRvHfEbDvA"              },              "travel_mode": "DRIVE",              "manuever": "exit-right"            },            {              "distance": {                "value": 259.18636,                "text": "259.2 ft"              },              "duration": {                "value": 0.19641666666666666,                "text": "0.2 min"              },              "start_location": {                "latitude": 40.701668,                "longitude": -73.961446              },              "end_location": {                "latitude": 40.701125,                "longitude": -73.960855              },              "instructions": "Turn left onto Wythe Avenue. Then Turn left onto Williamsburg Street East.",              "geometry": {                "polyline": "gmfslAj}falCtDyChWwZ|BkC"              },              "travel_mode": "DRIVE",              "manuever": "left"            },            {              "distance": {                "value": 141.07612,                "text": "141.1 ft"              },              "duration": {                "value": 0.18068333333333333,                "text": "0.2 min"              },              "start_location": {                "latitude": 40.701125,                "longitude": -73.960855              },              "end_location": {                "latitude": 40.701499,                "longitude": -73.960673              },              "instructions": "Turn left onto Williamsburg Street East. Then Bear left toward I 278 East.",              "geometry": {                "polyline": "ikeslAlxealC}D{AmPoG"              },              "travel_mode": "DRIVE",              "manuever": "left"            },            {              "distance": {                "value": 11059.71164,                "text": "2.1 mi"              },              "duration": {                "value": 2.7424666666666666,                "text": "3 mins"              },              "start_location": {                "latitude": 40.701499,                "longitude": -73.960673              },              "end_location": {                "latitude": 40.724281,                "longitude": -73.936285              },              "instructions": "Bear left toward I 278 East, Brooklyn-Queens Expressway.",              "geometry": {                "polyline": "ubfslA`mealCcc@uJmSmFqh@kPcf@aUoiA_i@evBcbA_]}PwuAkp@cBy@qSmKmCuAmq@y`@sXcPa]{RkO}IeyAk{@cTaNkSaOgQsO{HcIyu@ew@g_@{d@ya@{j@e`@km@w]ml@ckAqsBe}@y`Bsc@e{@gd@g|@iPk\\oSyb@aQk^mNmZkCsFoCsFkCiFgC{EuCaFoCwEmCqEyh@{x@gDkFmCkEoCwEgCuEiCeFcC_FaCiF{^ky@uDgI}BqF_CwFqCiHgCaHqB{FmBiGsAgFcBoGyAgGqAyFqAcGeAkFyAiIgBsKiHsd@"              },              "travel_mode": "DRIVE",              "manuever": "slight-left"            },            {              "distance": {                "value": 15072.17896,                "text": "2.9 mi"              },              "duration": {                "value": 3.8308666666666666,                "text": "4 mins"              },              "start_location": {                "latitude": 40.724281,                "longitude": -73.936285              },              "end_location": {                "latitude": 40.746265,                "longitude": -73.894711              },              "instructions": "Keep left to stay on Brooklyn-Queens Expressway.",              "geometry": {                "polyline": "qrrtlAxxu_lCmPg_AaFw\\wD{V{Ms|@_AsGeAsGcAkGeA{FmAqGuA{GsAyFuAkGyAuF}AwFeBmFwB{GmBuFiBaFqBeF}BuFoBeE_CaFqCsF_CwE}BaE}CaFuCqE_DwEgCqDeCyCqDaF}CqDkCaDsE{FgkB_|B}DmEaEaEwDwD_E}DyDuD{DoD}EiEwE{D_FeEyEuDmFwDqF{DwGqEsFmD{FmDyqC}_BsDyBwDaCqCqBeDgCkDqCkDuC_DuCqDmDkDsDyDkEaD{DoDaFsDyF}CgFkCuEiCsEyBwE}B{EoBoEuBmFuJo\\y@gCyDqMcDyLgEwMqBoJmB_JkBsImAcHaBiJmAoHiA{GcAwG}@iGu@uFw@{Gw@mGu@qHs@sH_A{L{@uQeAcQy@yPo@qPi@iQ_Bml@[aPu@kQ_AiP}}@s{McB}Wi@mHs@qHu@wHm@eFy@uG{@eGaAsGaAeGkAoGkAcGuAoGuAeGsAuFaBeGaByFcBuFmB}Fwd@{sAqEqM}E_OsE_OwDoM_@wAcCiJy@{CSw@uBcIcHmXeUi|@kB}GwAoF}AsF}AiFmBwF{BaGsBiF{BqF_CiFuBuEeCgFaCqEoCcFwCeFoDqFcHeKq|@}jA}M}PktA{gBom@}w@}R}WaLqMcF{E_GkF{FeEoEyC{DoCmEaC{DeBeGsBsFwAkFiA}GgAmF_@wEMeF?sFL}EZcE`@{Ej@cF|@wDr@iEdAuElAoEnA"              },              "travel_mode": "DRIVE",              "manuever": "stay-left"            },            {              "distance": {                "value": 849.73756,                "text": "849.7 ft"              },              "duration": {                "value": 0.2906833333333333,                "text": "0.3 min"              },              "start_location": {                "latitude": 40.746265,                "longitude": -73.894711              },              "end_location": {                "latitude": 40.748373,                "longitude": -73.895364              },              "instructions": "Take exit 40 on the right toward Roosevelt Avenue.",              "geometry": {                "polyline": "qp}ulAlrd}kCeTnDaKlEuIjDaNjFyEhB{MtFyMtFeOdIuFhAq@Ly@Aq@So@_@m@w@e@gA]oAkAiF"              },              "travel_mode": "DRIVE",              "manuever": "exit-right"            },            {              "distance": {                "value": 501.96852,                "text": "502.0 ft"              },              "duration": {                "value": 0.24676666666666666,                "text": "0.2 min"              },              "start_location": {                "latitude": 40.748373,                "longitude": -73.895364              },              "end_location": {                "latitude": 40.747697,                "longitude": -73.893793              },              "instructions": "Turn right onto Broadway.",              "geometry": {                "polyline": "itavlAf{e}kCtEmNdUqp@rIwYvAmE"              },              "travel_mode": "DRIVE",              "manuever": "right"            },            {              "distance": {                "value": 396.98163999999997,                "text": "397.0 ft"              },              "duration": {                "value": 0.29313333333333336,                "text": "0.3 min"              },              "start_location": {                "latitude": 40.747697,                "longitude": -73.893793              },              "end_location": {                "latitude": 40.74662,                "longitude": -73.893588              },              "instructions": "Turn right onto 72nd Street.",              "geometry": {                "polyline": "aj`vlA`yb}kCfFk@zQqBbb@wENApDa@"              },              "travel_mode": "DRIVE",              "manuever": "right"            },            {              "distance": {                "value": 2673.8846,                "text": "0.5 mi"              },              "duration": {                "value": 1.195,                "text": "1 min"              },              "start_location": {                "latitude": 40.74662,                "longitude": -73.893588              },              "end_location": {                "latitude": 40.745624,                "longitude": -73.90317              },              "instructions": "Turn right onto Roosevelt Avenue.",              "geometry": {                "polyline": "wf~ulAflb}kCdAbUpAjYpCvh@tAhW|Dnw@|Ddw@zDjv@rAbXxAvXPnDZnGjDzr@NxCRbEvDlu@NnCP`EvDhz@pEf_A"              },              "travel_mode": "DRIVE",              "manuever": "right"            },            {              "distance": {                "value": 0,                "text": "0.0 ft"              },              "duration": {                "value": 0,                "text": "0 min"              },              "start_location": {                "latitude": 40.745624,                "longitude": -73.90317              },              "end_location": {                "latitude": 40.745624,                "longitude": -73.90317              },              "instructions": "You have arrived at your destination.",              "geometry": {                "polyline": "oh|ulAbcu}kC"              },              "travel_mode": "DRIVE",              "manuever": "destination"            }          ]        },        {          "startLocation": {            "latitude": 40.74558,            "longitude": -73.903162          },          "endLocation": {            "latitude": 40.774419,            "longitude": -73.872746          },          "duration": {            "value": 8.387516666666667,            "text": "8 mins"          },          "distance": {            "value": 17129.26564,            "text": "3.2 mi"          },          "geometry": {            "polyline": "oh|ulAbcu}kCqEg_AwDiz@QaEOoCwDmu@ScEOyCkD{r@[oGQoDyAwXsAcX{Dkv@}Dew@wC\\ea@vEwAPgBTc_@jEqBTgCXg@Fef@pF_@D}C~@M}Cc@{Ke@}IoAqC_AaBeAy@kAm@oBg@s@UiAQcA?g@Pk@@_AZaAXu@\\qG~Cyg@xWgHjDoI|D}G~CeGnCaDfA{DhAaE`AiEx@sNzFsHl@aVnAm_@nD}ShDaQ`EiQfIs~@vg@mc@|V}CfBkZbJaa@pM_UlGwWpFkGxAe^|GkS`BaMz@qLQuM{@wQeDwM}DeNeFqQkGwg@q[e^_Ti_C}wA}l@i`@sE_DuDsCsDaDyDeEwCkDuCyD_DwEkLqRmCwDuDuEoDeE{CuC{CoC}EkDaAm@wBsAmF_CuDcAwEuAyQkEoEuAsDoAeD}A}CsBkCsByCyC}DqEiCyD}BsEuBwEeBmFkAkEeAaFs@_Gg@kG[sFSsHaAyh@c@eRm@cRcCyl@kAcVqIqs@{A_Q_B{PaBgPgBwPmBoPuBkPwBcPiCoQsBuMeCwOoC}OyCiPqCyO{C_PcDaPcDsOiDoOqDoOuDkO_EqOiEaOcEaOoE_OuE_O}E{N{EqNgFkN}Va}@mHuRcHkQqFaNaF}MyGiQgLkZaGqVm@sBq@kCmAaGoAyGgAiH_A{Gw@cH_@}EiEyy@wGesA]mJEqEuAKmWwAkJ[{EFwDZuARwB^sDp@sFhA}P`DwDl@yB\\cBTyEn@mVdFwBr@{B~@yCfBqEvDkElEcCxCk@x@eAvAgCwCOQmCeDqAqBmAoBaAsB}@mB{@{Bw@aCw@sCwBqJm@oCZgALMqA}GUmBg@yAkA}LmFin@eIe}@gByA_ET??"          },          "steps": [            {              "distance": {                "value": 1909.44888,                "text": "0.4 mi"              },              "duration": {                "value": 0.7839333333333334,                "text": "1 min"              },              "start_location": {                "latitude": 40.745624,                "longitude": -73.90317              },              "end_location": {                "latitude": 40.746333,                "longitude": -73.896325              },              "instructions": "Drive east on Roosevelt Avenue.",              "geometry": {                "polyline": "oh|ulAbcu}kCqEg_AwDiz@QaEOoCwDmu@ScEOyCkD{r@[oGQoDyAwXsAcX{Dkv@}Dew@"              },              "travel_mode": "DRIVE",              "manuever": "start"            },            {              "distance": {                "value": 777.55908,                "text": "777.6 ft"              },              "duration": {                "value": 0.4279,                "text": "0.4 min"              },              "start_location": {                "latitude": 40.746333,                "longitude": -73.896325              },              "end_location": {                "latitude": 40.748433,                "longitude": -73.896754              },              "instructions": "Turn left onto 69th Street.",              "geometry": {                "polyline": "yt}ulAhwg}kCwC\\ea@vEwAPgBTc_@jEqBTgCXg@Fef@pF_@D}C~@"              },              "travel_mode": "DRIVE",              "manuever": "left"            },            {              "distance": {                "value": 127.95276,                "text": "128.0 ft"              },              "duration": {                "value": 0.19558333333333333,                "text": "0.2 min"              },              "start_location": {                "latitude": 40.748433,                "longitude": -73.896754              },              "end_location": {                "latitude": 40.748477,                "longitude": -73.896294              },              "instructions": "Turn right onto 37th Avenue. Then Turn left to take the I 278 East ramp.",              "geometry": {                "polyline": "axavlAbrh}kCM}Cc@{Ke@}I"              },              "travel_mode": "DRIVE",              "manuever": "right"            },            {              "distance": {                "value": 2385.17068,                "text": "0.5 mi"              },              "duration": {                "value": 0.5895166666666667,                "text": "1 min"              },              "start_location": {                "latitude": 40.748477,                "longitude": -73.896294              },              "end_location": {                "latitude": 40.754551,                "longitude": -73.898787              },              "instructions": "Turn left to take the I 278 East ramp toward Brooklyn Queens Expressway, LaGuardia.",              "geometry": {                "polyline": "yzavlAjug}kCoAqC_AaBeAy@kAm@oBg@s@UiAQcA?g@Pk@@_AZaAXu@\\qG~Cyg@xWgHjDoI|D}G~CeGnCaDfA{DhAaE`AiEx@sNzFsHl@aVnAm_@nD}ShDaQ`EiQfIs~@vg@mc@|V}CfB"              },              "travel_mode": "DRIVE",              "manuever": "ramp-left"            },            {              "distance": {                "value": 7890.4202,                "text": "1.5 mi"              },              "duration": {                "value": 1.8856166666666667,                "text": "2 mins"              },              "start_location": {                "latitude": 40.754551,                "longitude": -73.898787              },              "end_location": {                "latitude": 40.768452,                "longitude": -73.882677              },              "instructions": "Keep right to take exit 42 onto Brooklyn-Queens Expressway East toward La Guardia Airport.",              "geometry": {                "polyline": "mvmvlAdql}kCkZbJaa@pM_UlGwWpFkGxAe^|GkS`BaMz@qLQuM{@wQeDwM}DeNeFqQkGwg@q[e^_Ti_C}wA}l@i`@sE_DuDsCsDaDyDeEwCkDuCyD_DwEkLqRmCwDuDuEoDeE{CuC{CoC}EkDaAm@wBsAmF_CuDcAwEuAyQkEoEuAsDoAeD}A}CsBkCsByCyC}DqEiCyD}BsEuBwEeBmFkAkEeAaFs@_Gg@kG[sFSsHaAyh@c@eRm@cRcCyl@kAcVqIqs@{A_Q_B{PaBgPgBwPmBoPuBkPwBcPiCoQsBuMeCwOoC}OyCiPqCyO{C_PcDaPcDsOiDoOqDoOuDkO_EqOiEaOcEaOoE_OuE_O}E{N{EqNgFkN"              },              "travel_mode": "DRIVE",              "manuever": "stay-right"            },            {              "distance": {                "value": 2017.7166,                "text": "0.4 mi"              },              "duration": {                "value": 0.7967,                "text": "1 min"              },              "start_location": {                "latitude": 40.768452,                "longitude": -73.882677              },              "end_location": {                "latitude": 40.770346,                "longitude": -73.875965              },              "instructions": "Take exit 6 on the right toward Parking B, 94th Street.",              "geometry": {                "polyline": "g{hwlAhbm|kC}Va}@mHuRcHkQqFaNaF}MyGiQgLkZaGqVm@sBq@kCmAaGoAyGgAiH_A{Gw@cH_@}EiEyy@wGesA]mJEqE"              },              "travel_mode": "DRIVE",              "manuever": "exit-right"            },            {              "distance": {                "value": 1017.0604,                "text": "0.2 mi"              },              "duration": {                "value": 0.4999,                "text": "0.5 min"              },              "start_location": {                "latitude": 40.770346,                "longitude": -73.875965              },              "end_location": {                "latitude": 40.772982,                "longitude": -73.876731              },              "instructions": "Turn left onto 94th Street.",              "geometry": {                "polyline": "sqlwlAx~_|kCuAKmWwAkJ[{EFwDZuARwB^sDp@sFhA}P`DwDl@yB\\cBTyEn@mVdFwBr@{B~@yCfBqEvDkElEcCxCk@x@eAvA"              },              "travel_mode": "DRIVE",              "manuever": "left"            },            {              "distance": {                "value": 295.2756,                "text": "295.3 ft"              },              "duration": {                "value": 0.2730166666666667,                "text": "0.3 min"              },              "start_location": {                "latitude": 40.772982,                "longitude": -73.876731              },              "end_location": {                "latitude": 40.773442,                "longitude": -73.875879              },              "instructions": "Turn right onto Runway Drive. Then, in 90 meters, Turn right.",              "geometry": {                "polyline": "kvqwlAtna|kCgCwCOQmCeDqAqBmAoBaAsB}@mB{@{Bw@aCw@sCwBqJm@oC"              },              "travel_mode": "DRIVE",              "manuever": "right"            },            {              "distance": {                "value": 13.12336,                "text": "13.1 ft"              },              "duration": {                "value": 0.028916666666666667,                "text": "0 min"              },              "start_location": {                "latitude": 40.773442,                "longitude": -73.875879              },              "end_location": {                "latitude": 40.773421,                "longitude": -73.875836              },              "instructions": "Turn right. Then Turn left.",              "geometry": {                "polyline": "csrwlAly_|kCZgALM"              },              "travel_mode": "DRIVE",              "manuever": "right"            },            {              "distance": {                "value": 688.9764,                "text": "689.0 ft"              },              "duration": {                "value": 0.5099166666666667,                "text": "1 min"              },              "start_location": {                "latitude": 40.773421,                "longitude": -73.875836              },              "end_location": {                "latitude": 40.773961,                "longitude": -73.873584              },              "instructions": "Turn left.",              "geometry": {                "polyline": "yqrwlAvv_|kCqA}GUmBg@yAkA}LmFin@eIe}@gByA_ET??"              },              "travel_mode": "DRIVE",              "manuever": "left"            },            {              "distance": {                "value": 0,                "text": "0.0 ft"              },              "duration": {                "value": 0,                "text": "0 min"              },              "start_location": {                "latitude": 40.773961,                "longitude": -73.873584              },              "end_location": {                "latitude": 40.773961,                "longitude": -73.873584              },              "instructions": "Your destination is on the right.",              "geometry": {                "polyline": "qsswlA~i{{kC"              },              "travel_mode": "DRIVE",              "manuever": "destination-right"            }          ]        }      ],      "geometry": {        "polyline": "kafulAnn`clCfKxAhCF`CJdg@vGtB\\|BZfJrAh[lEhC^dBThMjBjRjCdBZn@Pd@Nh@Pf@Vf@Vh@`@vWxSv@l@t@l@`BpArB`BtYjU~AlAbBtA`BzAdVnQfEhD`ClBhRfOlCxBjBxAhBxAxKzItNhL|BhBnB|Af]rXnB~A|AnAn[fWbAv@~ArAzBfBxStPbInGtB`BlBzA~b@l]bAx@d@\\jBxAjMdKTPxGlFnJvH|StPnCxBhFbEr@{EfEeYvCyRf@kD\\{BBUtC}RfAoFbAcFpDsNh@qBp@oCfLcd@r@sCn@cC`Lsc@p@kCl@aCjE}P`E}O^cBhAgFvDbAd@L~fAtYhTrF~Ab@tBh@rA\\bd@vLvA^|Ab@`B^f`@dLxAf@lBl@xAd@tF~AxPzEpBl@tF~AnAmFpBsD~BkE`DyNlGmY^cBjA_G`AwEX}AnG}Zd@}B~@uEj@uCtKyh@XsAh@gCd@yBbJ{c@\\aBr@iD~AeIz@yDn@wCpD}PVmAf@eCf@eC`Joc@VsAf@aCd@}BpHm^r@kDXoAfAkFbA{EtIsb@Z}A`@uBR_AXeAd@}A`AwCtEsNrAsEjAeEb@aBd@aBr@sCz@cDjBcHbIoY|@kD\\qAXkAxDgRzAmHzSgdA~J_g@|\\gcBpb@_uB|U{kAdIcTdVqpAl~DssRj_@{hB|Fq_@zt@opDtG_UrEcU`AoFjCkOd@yC`@}CToCTwChAeTx@}PRkCb@eDd@gCn@sCrP_r@\\uAjAuEmCuAsP}I}KsG}@i@kAq@QeFo@uTAMiBy_@wBac@KkBMsBSaDk@mIs@{Io@aMmBs]{AmXS}EQ{CoBac@OeDeA{ScAoTUmEUeEsA{X}@yPoEi~@WkF}AcPScFG}AUkFaDXm[fCgKv@aCRec@hD_CP{CZo]bDyGn@}k@pFgIj@wCR?jG@jX@bY@vJ?lEAnEEpX?zCAdKA~GGva@vDdBjM~G~DpBdCpAd[~OrMxG~DGbN|EdZjOvUhKhQvInPnFfOjDxYnFzNlEhQbHviAhi@d{Axs@tW~LfyBldAv`@fSll@fZtB|E~m@x\\fUhMzNhKjTnRvHfEbDvAtDyChWwZ|BkC}D{AmPoGcc@uJmSmFqh@kPcf@aUoiA_i@evBcbA_]}PwuAkp@cBy@qSmKmCuAmq@y`@sXcPa]{RkO}IeyAk{@cTaNkSaOgQsO{HcIyu@ew@g_@{d@ya@{j@e`@km@w]ml@ckAqsBe}@y`Bsc@e{@gd@g|@iPk\\oSyb@aQk^mNmZkCsFoCsFkCiFgC{EuCaFoCwEmCqEyh@{x@gDkFmCkEoCwEgCuEiCeFcC_FaCiF{^ky@uDgI}BqF_CwFqCiHgCaHqB{FmBiGsAgFcBoGyAgGqAyFqAcGeAkFyAiIgBsKiHsd@mPg_AaFw\\wD{V{Ms|@_AsGeAsGcAkGeA{FmAqGuA{GsAyFuAkGyAuF}AwFeBmFwB{GmBuFiBaFqBeF}BuFoBeE_CaFqCsF_CwE}BaE}CaFuCqE_DwEgCqDeCyCqDaF}CqDkCaDsE{FgkB_|B}DmEaEaEwDwD_E}DyDuD{DoD}EiEwE{D_FeEyEuDmFwDqF{DwGqEsFmD{FmDyqC}_BsDyBwDaCqCqBeDgCkDqCkDuC_DuCqDmDkDsDyDkEaD{DoDaFsDyF}CgFkCuEiCsEyBwE}B{EoBoEuBmFuJo\\y@gCyDqMcDyLgEwMqBoJmB_JkBsImAcHaBiJmAoHiA{GcAwG}@iGu@uFw@{Gw@mGu@qHs@sH_A{L{@uQeAcQy@yPo@qPi@iQ_Bml@[aPu@kQ_AiP}}@s{McB}Wi@mHs@qHu@wHm@eFy@uG{@eGaAsGaAeGkAoGkAcGuAoGuAeGsAuFaBeGaByFcBuFmB}Fwd@{sAqEqM}E_OsE_OwDoM_@wAcCiJy@{CSw@uBcIcHmXeUi|@kB}GwAoF}AsF}AiFmBwF{BaGsBiF{BqF_CiFuBuEeCgFaCqEoCcFwCeFoDqFcHeKq|@}jA}M}PktA{gBom@}w@}R}WaLqMcF{E_GkF{FeEoEyC{DoCmEaC{DeBeGsBsFwAkFiA}GgAmF_@wEMeF?sFL}EZcE`@{Ej@cF|@wDr@iEdAuElAoEnAeTnDaKlEuIjDaNjFyEhB{MtFyMtFeOdIuFhAq@Ly@Aq@So@_@m@w@e@gA]oAkAiFtEmNdUqp@rIwYvAmEfFk@zQqBbb@wENApDa@dAbUpAjYpCvh@tAhW|Dnw@|Ddw@zDjv@rAbXxAvXPnDZnGjDzr@NxCRbEvDlu@NnCP`EvDhz@pEf_AqEg_AwDiz@QaEOoCwDmu@ScEOyCkD{r@[oGQoDyAwXsAcX{Dkv@}Dew@wC\\ea@vEwAPgBTc_@jEqBTgCXg@Fef@pF_@D}C~@M}Cc@{Ke@}IoAqC_AaBeAy@kAm@oBg@s@UiAQcA?g@Pk@@_AZaAXu@\\qG~Cyg@xWgHjDoI|D}G~CeGnCaDfA{DhAaE`AiEx@sNzFsHl@aVnAm_@nD}ShDaQ`EiQfIs~@vg@mc@|V}CfBkZbJaa@pM_UlGwWpFkGxAe^|GkS`BaMz@qLQuM{@wQeDwM}DeNeFqQkGwg@q[e^_Ti_C}wA}l@i`@sE_DuDsCsDaDyDeEwCkDuCyD_DwEkLqRmCwDuDuEoDeE{CuC{CoC}EkDaAm@wBsAmF_CuDcAwEuAyQkEoEuAsDoAeD}A}CsBkCsByCyC}DqEiCyD}BsEuBwEeBmFkAkEeAaFs@_Gg@kG[sFSsHaAyh@c@eRm@cRcCyl@kAcVqIqs@{A_Q_B{PaBgPgBwPmBoPuBkPwBcPiCoQsBuMeCwOoC}OyCiPqCyO{C_PcDaPcDsOiDoOqDoOuDkO_EqOiEaOcEaOoE_OuE_O}E{N{EqNgFkN}Va}@mHuRcHkQqFaNaF}MyGiQgLkZaGqVm@sBq@kCmAaGoAyGgAiH_A{Gw@cH_@}EiEyy@wGesA]mJEqEuAKmWwAkJ[{EFwDZuARwB^sDp@sFhA}P`DwDl@yB\\cBTyEn@mVdFwBr@{B~@yCfBqEvDkElEcCxCk@x@eAvAgCwCOQmCeDqAqBmAoBaAsB}@mB{@{Bw@aCw@sCwBqJm@oCZgALMqA}GUmBg@yAkA}LmFin@eIe}@gByA_ET??"      }    }  ]}
```

Copy

#### []()Optimize route[#](#optimize-route "Direct link to heading")

Calculates the optimal ordering and route to visit a list of locations.

###### []()Definitions[#](#definitions-13 "Direct link to heading")

GET `https://api.radar.io/v1/route/optimize`

###### []()Query parameters[#](#query-parameters-11 "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-14 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-13 "Direct link to heading")

10 requests per second (contact your customer success manager to increase rate limit)

###### []()Sample request[#](#sample-request-15 "Direct link to heading")

```
curl "https://api.radar.io/v1/route/optimize?locations=40.7343164,-73.995688|40.6396701,-73.9257626|40.6390023,-73.9975035|40.7227423,-73.9983234|40.6410279,-73.7746107&mode=car&units=imperial" \  -H "Authorization: prj_live_pk_..."
```

Copy

###### []()Sample response[#](#sample-response-13 "Direct link to heading")
...
###### []()Default rate limit[#](#default-rate-limit-14 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-15 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-16 "Direct link to heading")
...
###### []()Sample response[#](#sample-response-14 "Direct link to heading")

```
{  "meta": {    "code": 200,    "hasMore": true  },  "users": [    {      "_id": "56db1f4613012711002229f4",      "live": true,      "userId": "1",      "deviceId": "C305F2DB-56DC-404F-B6C1-BC52F0B680D8",      ...    },    ...  ]}
```

Copy

#### []()Get a user[#](#get-a-user "Direct link to heading")

Gets a user. The user can be referenced by Radar `_id`, `userId`, or `deviceId`.

###### []()Definition[#](#definition-2 "Direct link to heading")

GET `https://api.radar.io/v1/users/:id`

###### []()Default rate limit[#](#default-rate-limit-15 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-16 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-17 "Direct link to heading")
...
###### []()Sample response[#](#sample-response-15 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "user": {    "_id": "56db1f4613012711002229f4",    "live": true,    "userId": "1",    "deviceId": "C305F2DB-56DC-404F-B6C1-BC52F0B680D8",    ...  }}
```

Copy

#### []()Delete a user[#](#delete-a-user "Direct link to heading")

Deletes a user. The user can be referenced by Radar `_id`, `userId`, or `deviceId`.

###### []()Definition[#](#definition-3 "Direct link to heading")

DELETE `https://api.radar.io/v1/users/:id`

###### []()Default rate limit[#](#default-rate-limit-16 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-17 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-18 "Direct link to heading")

```
curl "https://api.radar.io/v1/users/56db1f4613012711002229f4" \  -H "Authorization: prj_live_sk_..." \  -X DELETE
```

Copy

###### []()Sample response[#](#sample-response-16 "Direct link to heading")
...
### []()Trips[#](#trips "Direct link to heading")
...
###### []()Object fields[#](#object-fields-1 "Direct link to heading")
...
###### []()Sample object[#](#sample-object-1 "Direct link to heading")
...
#### []()Get a trip[#](#get-a-trip "Direct link to heading")

Gets a trip. The trip can be referenced by Radar `_id` or `externalId`.

###### []()Definition[#](#definition-4 "Direct link to heading")

GET `https://api.radar.io/v1/trips/:id`GET `https://api.radar.io/v1/trips/:externalId`

###### []()Default rate limit[#](#default-rate-limit-17 "Direct link to heading")

10 requests per second

###### []()Sample request[#](#sample-request-19 "Direct link to heading")

```
curl "https://api.radar.io/v1/trips/299" \  -H "Authorization: prj_live_sk_..."
```

Copy

###### []()Authentication level[#](#authentication-level-18 "Direct link to heading")

Secret

###### []()Sample response[#](#sample-response-17 "Direct link to heading")

```
{  "_id": "5f3e50491c2b7d005c81f5d9",  "live": true,  "status": "started",  "externalId": "299",  "metadata": {    "Customer Name": "Jacob Pena",    "Car Model": "Green Honda Civic"  },  "mode": "car",  "destinationGeofenceTag": "store",  "destinationGeofenceExternalId": "123",  "destinationLocation": {    "coordinates": [      -105.061198,      39.779366    ],    "type": "Point"  },  "eta": {    "duration": 5.5,    "distance": 1331  },  ...}
```

Copy

#### []()Get the route for a trip[#](#get-the-route-for-a-trip "Direct link to heading")
...
###### []()Definition[#](#definition-5 "Direct link to heading")

GET `https://api.radar.io/v1/trips/:id/route`GET `https://api.radar.io/v1/trips/:externalId/route`

###### []()Default rate limit[#](#default-rate-limit-18 "Direct link to heading")

100 requests per second

###### []()Sample request[#](#sample-request-20 "Direct link to heading")

```
curl "https://api.radar.io/v1/trips/299/route" \  -H "Authorization: prj_live_sk_..."
```

Copy

###### []()Authentication level[#](#authentication-level-19 "Direct link to heading")

Secret

###### []()Sample response[#](#sample-response-18 "Direct link to heading")

```
{  "distance": {    "value": 1077.1173573024,    "text": "0.2 mi"  },  "geometry": {    "polyline": "waczjAhnokgEia@BcXXga@Ri|@KmIDsIDyD@mD@"  }}
```

Copy

#### []()List trips[#](#list-trips "Direct link to heading")

###### []()Definition[#](#definition-6 "Direct link to heading")

Lists trips. Trips are sorted descending by `updatedAt`.

GET `https://api.radar.io/v1/trips`

###### []()Query parameters[#](#query-parameters-13 "Direct link to heading")
...
###### []()Default rate limit[#](#default-rate-limit-19 "Direct link to heading")

10 requests per second

###### []()Sample request[#](#sample-request-21 "Direct link to heading")

```
curl "https://api.radar.io/v1/trips?status=started&destinationGeofenceTag=store&destinationGeofenceExternalId=123&externalId=123,456,789" \  -H "Authorization: prj_live_sk_..."
```

Copy

###### []()Authentication level[#](#authentication-level-20 "Direct link to heading")

Secret

###### []()Sample response[#](#sample-response-19 "Direct link to heading")
...
#### []()Create a new trip[#](#create-a-new-trip "Direct link to heading")
...
###### []()Definition[#](#definition-7 "Direct link to heading")

Creates a new trip.

POST `https://api.radar.io/v1/trips`

###### []()Body parameters[#](#body-parameters-1 "Direct link to heading")
...
###### []()Default rate limit[#](#default-rate-limit-20 "Direct link to heading")

10 requests per second

###### []()Sample request[#](#sample-request-22 "Direct link to heading")

```
curl "https://api.radar.io/v1/trips" \  -H "Authorization: prj_test_pk_..." \  -X POST \  -d "externalId=123" \  -d "mode=car" \  -d "destinationGeofenceTag=store" \  -d "destinationGeofenceExternalId=1" \  -d "userId=001" \  -d "approachingThreshold=3" \  -d "metadata={\"foo\": \"bar\"}"
```

Copy

###### []()Authentication level[#](#authentication-level-21 "Direct link to heading")

Publishable

###### []()Sample response[#](#sample-response-20 "Direct link to heading")
...
#### []()Update a trip[#](#update-a-trip "Direct link to heading")

Updates a trip. The trip can be referenced by Radar `_id` or `externalId`.

On iOS and Android, use the [SDK](/sdk) to update trips.

###### []()Definition[#](#definition-8 "Direct link to heading")

PATCH `https://api.radar.io/v1/trips/:id/update`PATCH `https://api.radar.io/v1/trips/:externalId/update`

###### []()Body parameters[#](#body-parameters-2 "Direct link to heading")
...
###### []()Default rate limit[#](#default-rate-limit-21 "Direct link to heading")

10 requests per second

###### []()Sample request[#](#sample-request-23 "Direct link to heading")

```
curl "https://api.radar.io/v1/trips/299/update" \  -H "Authorization: prj_live_sk_..."  -X PATCH  -d "status=completed"
```

Copy

###### []()Authentication level[#](#authentication-level-22 "Direct link to heading")

Publishable

###### []()Sample response[#](#sample-response-21 "Direct link to heading")
...
#### []()Delete a trip[#](#delete-a-trip "Direct link to heading")

Deletes a trip. The trip can be referenced by Radar `_id` or `externalId`.

###### []()Definition[#](#definition-9 "Direct link to heading")

DELETE `https://api.radar.io/v1/trips/:id`

###### []()Default rate limit[#](#default-rate-limit-22 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-23 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-24 "Direct link to heading")

```
curl "https://api.radar.io/v1/trips/56db1f4613012711002229f4" \  -H "Authorization: prj_live_sk_..." \  -X DELETE
```

Copy

###### []()Sample response[#](#sample-response-22 "Direct link to heading")
...
### []()Geofences[#](#geofences "Direct link to heading")
...
###### []()Object fields[#](#object-fields-2 "Direct link to heading")
...
###### []()Sample object[#](#sample-object-2 "Direct link to heading")

```
{  "_id": "56db1f4613012711002229f5",  "createdAt": "2016-06-10T13:44:10.535Z",  "updatedAt": "2016-06-10T14:40:10.535Z",  "live": true,  "tag": "venue",  "externalId": "2",  "description": "Coffee Shop",  "type": "circle",  "geometry": {    "type": "Polygon",    "coordinates": [[...]]  },  "geometryCenter": {    "type": "Point",    "coordinates": [-73.97536, 40.78382]  },  "geometryRadius": 50,  "metadata": {    ...  },  "enabled": true}
```

Copy

#### []()List geofences[#](#list-geofences "Direct link to heading")

###### []()Definition[#](#definition-10 "Direct link to heading")

Lists geofences. Geofences are sorted descending by `updatedAt`.

GET `https://api.radar.io/v1/geofences`

###### []()Query parameters[#](#query-parameters-14 "Direct link to heading")
...
###### []()Default rate limit[#](#default-rate-limit-23 "Direct link to heading")

10 requests per second

###### []()Sample request[#](#sample-request-25 "Direct link to heading")

```
curl "https://api.radar.io/v1/geofences" \  -H "Authorization: prj_live_sk_..."
```

Copy

###### []()Authentication level[#](#authentication-level-24 "Direct link to heading")

Secret

###### []()Sample response[#](#sample-response-23 "Direct link to heading")

```
{  "meta": {    "code": 200,    "hasMore": true  },  "geofences": [    {      "_id": "56db1f4613012711002229f5",      "createdAt": "2016-06-10T13:44:10.535Z",      "live": true,      "tag": "venue",      "externalId": "2",      "description": "Coffee Shop",      "type": "circle",      ...    },    ...  ]}
```

Copy

#### []()Get a geofence[#](#get-a-geofence "Direct link to heading")

Gets a geofence. The geofence can be uniquely referenced by Radar `_id` or by `tag` and `externalId`.

###### []()Definition[#](#definition-11 "Direct link to heading")

GET `https://api.radar.io/v1/geofences/:id`GET `https://api.radar.io/v1/geofences/:tag/:externalId`

###### []()Default rate limit[#](#default-rate-limit-24 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-25 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-26 "Direct link to heading")

```
curl "https://api.radar.io/v1/geofences/56db1f4613012711002229f5" \  -H "Authorization: prj_live_sk_..."
```

Copy

###### []()Sample response[#](#sample-response-24 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "geofence": {    "_id": "56db1f4613012711002229f5",    "createdAt": "2016-06-10T13:44:10.535Z",    "live": true,    "tag": "venue",    "externalId": "2",    "description": "Coffee Shop",    "type": "circle",    ...  }}
```

Copy

#### []()Upsert a geofence[#](#upsert-a-geofence "Direct link to heading")
...
###### []()Definition[#](#definition-12 "Direct link to heading")

PUT `https://api.radar.io/v1/geofences/:tag/:externalId`PUT `https://api.radar.io/v1/geofences/:id`

###### []()Body parameters[#](#body-parameters-3 "Direct link to heading")
...
###### []()Default rate limit[#](#default-rate-limit-25 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-26 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-27 "Direct link to heading")

```
curl "https://api.radar.io/v1/geofences/venue/2" \  -H "Authorization: prj_live_sk_..." \  -X PUT \  -d "description=Coffee Shop" \  -d "type=circle" \  -d "coordinates=[-73.97536,40.78382]" \  -d "radius=50"
```

Copy

###### []()Sample response[#](#sample-response-25 "Direct link to heading")
...
#### []()Delete a geofence[#](#delete-a-geofence "Direct link to heading")

Deletes a geofence. The geofence can be uniquely referenced by Radar `_id` or by `tag` and `externalId`.

###### []()Definition[#](#definition-13 "Direct link to heading")

DELETE `https://api.radar.io/v1/geofences/:id`DELETE `https://api.radar.io/v1/geofences/:tag/:externalId`

###### []()Default rate limit[#](#default-rate-limit-26 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-27 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-28 "Direct link to heading")

```
curl "https://api.radar.io/v1/geofences/56db1f4613012711002229f5" \  -H "Authorization: prj_live_sk_..." \  -X DELETE
```

Copy

###### []()Sample response[#](#sample-response-26 "Direct link to heading")
...
#### []()Get users in a geofence[#](#get-users-in-a-geofence "Direct link to heading")

Gets users currently in a geofence.

###### []()Definition[#](#definition-14 "Direct link to heading")

GET `https://api.radar.io/v1/geofences/:tag/:externalId/users`

###### []()Default rate limit[#](#default-rate-limit-27 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-28 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-29 "Direct link to heading")

```
curl "https://api.radar.io/v1/geofences/venue/2/users" \  -H "Authorization: prj_live_sk_..."
```

Copy

###### []()Sample response[#](#sample-response-27 "Direct link to heading")

```
{  "meta": {    "code": 200,    "hasMore": false  },  "users": [    {      "_id": "611ace2eb08f300047c904e9",      "location": {        "type": "Point",        "coordinates": [          73.97536,          40.78382        ]      },      ...    }    ...  ]}
```
...
###### []()Object fields[#](#object-fields-3 "Direct link to heading")
...
###### []()Sample object[#](#sample-object-3 "Direct link to heading")
...
#### []()Generate an entry or exit event[#](#generate-an-entry-or-exit-event "Direct link to heading")
...
#### []()Log a conversion[#](#log-a-conversion "Direct link to heading")
...
###### []()Definition[#](#definition-15 "Direct link to heading")

POST `https://api.radar.io/v1/events`

###### []()Body parameters[#](#body-parameters-4 "Direct link to heading")
...
###### []()Authentication level[#](#authentication-level-29 "Direct link to heading")

Publishable

###### []()Default rate limit[#](#default-rate-limit-28 "Direct link to heading")

10 requests per second

###### []()Sample request[#](#sample-request-30 "Direct link to heading")

```
curl "https://api.radar.io/v1/events" \  -H "Authorization: prj_live_pk_..." \  -X POST \  -d "name=conversion" \  -d "userId=user123"
```

Copy

###### []()Sample response[#](#sample-response-28 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "event": {    "_id": "56db1f4613012711002229f6",    "createdAt": "2016-06-10T13:44:10.535Z",    "live": true,    "type": "conversion",    "confidence": 3,    "user": {      "_id": "56db1f4613012711002229f4",      "userId": "user123",      "deviceId": "C305F2DB-56DC-404F-B6C1-BC52F0B680D8",      ...    }  }}
```
...
###### []()Object fields[#](#object-fields-4 "Direct link to heading")
...
###### []()Default rate limit[#](#default-rate-limit-29 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-30 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-31 "Direct link to heading")

```
curl "https://api.radar.io/v1/beacons" \  -H "Authorization: prj_live_sk_..."
```

Copy

###### []()Sample response[#](#sample-response-29 "Direct link to heading")

```
{  "meta": {    "code": 200,    "hasMore": true  },  "beacons": [    {      "_id": "6109a4b16dbfe3de2cb03924",      "createdAt": "2021-08-03T20:18:57.888Z",      "updatedAt": "2021-08-03T20:18:57.888Z",      "live": true,      "description": "Store #123 - Register #1",      ...    },    ...  ]}
```

Copy

#### []()Get a beacon[#](#get-a-beacon "Direct link to heading")

Gets a beacon. The beacon can be uniquely referenced by Radar `_id` or by `tag` and `externalId`.

###### []()Definition[#](#definition-17 "Direct link to heading")

GET `https://api.radar.io/v1/beacons/:id`GET `https://api.radar.io/v1/beacons/:tag/:externalId`

###### []()Default rate limit[#](#default-rate-limit-30 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-31 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-32 "Direct link to heading")

```
curl "https://api.radar.io/v1/beacons/6109a4b16dbfe3de2cb03924" \  -H "Authorization: prj_live_sk_..."
```

Copy

###### []()Sample response[#](#sample-response-30 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "beacon": {    "_id": "6109a4b16dbfe3de2cb03924",    "createdAt": "2021-08-03T20:18:57.888Z",    "updatedAt": "2021-08-03T20:18:57.888Z",    "live": true,    "description": "Store #123 - Register #1",    "tag": "store-register",    "externalId": "123-1",    ...  }}
```

Copy

#### []()Create a beacon[#](#create-a-beacon "Direct link to heading")

Creates a beacon.

###### []()Definition[#](#definition-18 "Direct link to heading")

POST `https://api.radar.io/v1/beacons`

###### []()Body parameters[#](#body-parameters-5 "Direct link to heading")
...
###### []()Default rate limit[#](#default-rate-limit-31 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-32 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-33 "Direct link to heading")

```
curl "https://api.radar.io/v1/beacons" \  -H "Authorization: prj_live_sk_..." \  -X POST \  -d "description=Store 123 - Register 1" \  -d "tag=store-register" \  -d "tag=123-1" \  -d "type=ibeacon" \  -d "uuid=b9407f30-f5f8-466e-aff9-25556b57fe6d" \  -d "major=100" \  -d "minor=1"  -d "coordinates=[-105.94653744704361,35.70654086799666]" \  -d "enabled=true"
```

Copy

###### []()Sample response[#](#sample-response-31 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "beacon": {    "_id": "6116d947049aee0089a682a2",    "createdAt": "2021-08-13T20:42:47.711Z",    "updatedAt": "2021-08-13T20:42:47.711Z",    "live": true,    "description": "Store #123 - Register #1",    "tag": "store-register",    "externalId": "123-1",    ...  }}
```

Copy

#### []()Upsert a beacon[#](#upsert-a-beacon "Direct link to heading")
...
###### []()Definition[#](#definition-19 "Direct link to heading")

PUT `https://api.radar.io/v1/beacons/:id`PUT `https://api.radar.io/v1/beacons/:tag/:externalId`

###### []()Body parameters[#](#body-parameters-6 "Direct link to heading")
...
###### []()Default rate limit[#](#default-rate-limit-32 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-33 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-34 "Direct link to heading")
...
###### []()Sample response[#](#sample-response-32 "Direct link to heading")
...
#### []()Delete a beacon[#](#delete-a-beacon "Direct link to heading")

Deletes a beacon. The beacon can be uniquely referenced by Radar `_id` or by `tag` and `externalId`.

###### []()Definition[#](#definition-20 "Direct link to heading")

DELETE `https://api.radar.io/v1/beacons/:id`DELETE `https://api.radar.io/v1/beacons/:tag/:externalId`

###### []()Default rate limit[#](#default-rate-limit-33 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-34 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-35 "Direct link to heading")

```
curl "https://api.radar.io/v1/beacons/56db1f4613012711002229f4" \  -H "Authorization: prj_live_sk_..." \  -X DELETE
```

Copy

###### []()Sample response[#](#sample-response-33 "Direct link to heading")
...
## []()Manage your Radar project settings[#](#manage-your-radar-project-settings "Direct link to heading")

### []()Places settings[#](#places-settings "Direct link to heading")

Places settings represents your current project settings for [Places](/places).

###### []()Object fields[#](#object-fields-5 "Direct link to heading")
...
#### []()Get Places settings[#](#get-places-settings "Direct link to heading")

Gets your current Places settings.

###### []()Definition[#](#definition-21 "Direct link to heading")

GET `https://api.radar.io/v1/settings`

###### []()Default rate limit[#](#default-rate-limit-34 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-35 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-36 "Direct link to heading")

```
curl "https://api.radar.io/v1/settings" \  -H "Authorization: prj_live_sk_..." \  -X GET
```

Copy

###### []()Sample response[#](#sample-response-34 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "chainMetadata": {    "mcdonalds": {      "availableDeals": true,    },    "starbucks": {      "availableDeals": true,    }  },  "chainMappings": {    "mcdonalds": "retailer1",    "starbucks": "retailer2"  },  "placeFilters": {    "chain": [      "mcdonalds",      "starbucks"    ],    "category": [      "restaurant"    ]  }}
```

Copy

#### []()Update Places settings[#](#update-places-settings "Direct link to heading")

Updates your Places settings.

###### []()Definition[#](#definition-22 "Direct link to heading")

PATCH `https://api.radar.io/v1/settings`

###### []()Default rate limit[#](#default-rate-limit-35 "Direct link to heading")

10 requests per second

###### []()Authentication level[#](#authentication-level-36 "Direct link to heading")

Secret

###### []()Sample request[#](#sample-request-37 "Direct link to heading")

```
curl "https://api.radar.io/v1/settings" \  -H "Authorization: prj_live_sk_..." \  -H "Content-Type: application/json" \  -X PATCH \  -d '{"chainMetadata":{"mcdonalds":{"availableDeals":false}},"chainMappings":{"mcdonalds":"retailer1"},"placeFilters":{"chain":["mcdonalds"]}}'
```

Copy

###### []()Sample response[#](#sample-response-35 "Direct link to heading")

```
{  "meta": {    "code": 200  },  "chainMetadata": {    "mcdonalds": {      "availableDeals": false    }  },  "chainMappings": {    "mcdonalds": "retailer1"  },  "placeFilters": {    "chain": [      "mcdonalds"    ]  }}
```
